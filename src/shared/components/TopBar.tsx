...
export default function TopBar() {
  return (
    <div className="hidden text-sm text-white md:block">
      <div className="site-shell-width site-glass-nav mx-auto mb-2 flex flex-col gap-3 rounded-3xl border border-white/10 px-5 py-3 shadow-sm shadow-black/20 backdrop-blur sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
